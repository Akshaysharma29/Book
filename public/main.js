...
module.exports = "<p>\n  particular works!\n  \n</p>\n\n\n<div style=\"width:100%; margin: 20px auto;\">\n<div *ngFor=\"let i of Particular\" style=\"max-width:400px;background: white; margin: 0 auto; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); border-radius: 10px; padding: 4px\">\n    <p>\n        <br>\n    </p>\n    <img src=\"{{i.imageurl}}\" style=\"width:400px; height: 400px; border-radius: 4px; \"><br>\n    <span>Seller     :{{i.name}}</span><br>\n    <span>Bookname   :{{i.bookname}}</span><br>\n    <span>Authorname :{{i.authorname}}</span><br>\n    <span>Price      :{{i.price}} Rs</span><br>\n    <span>Condition  :{{i.condition}}</span> <br>\n    <button (click)= \"addtowishlist(i.id,i.name,i.bookname,i.authorname,i.price,i.condition,i.imageurl)\" class=\"signupbtn\">Add to wishlist</button><br>\n  </div>\n\n  <form (submit)=\"sendmessage($event)\" style=\"max-width:400px;background: white; margin: 0 auto; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); border-radius: 10px; padding: 4px\">\n   <p>Write your message here:</p>\n    <textarea rows=\"4\" cols=\"50\" id=\"message\" required ></textarea>    \n  <input type=\"submit\" value=\"Send message\" class=\"signupbtn\" >\n  </form>\n\n\n</div>\n"
...
module.exports = "<p>\n  wishlist works!\n</p>\n\n\n<div style=\"width:100%; margin: 20px auto;\">\n<div *ngFor=\"let i of obj\" style=\"max-width:400px;background: white; margin: 20px 1.5%; float: left; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);; border-radius: 10px; padding: 4px\">\n  <p>\n    <br>\n  </p>\n  <img src=\"{{i.imageurl}}\" style=\"width:100%; height: 400px; border-radius: 4px;\"><br>\n  <span>Seller     :{{i.name}}</span><br>\n  <span>Bookname   :{{i.bookname}}</span><br>\n  <span>Authorname :{{i.authorname}}</span><br>\n  <span>Price      :{{i.price}} Rs</span><br>\n  <span>Condition  :{{i.condition}}</span> <br>\n  <!-- <button (click)= \"addtowishlist()\">Add to wishlist</button><br> -->\n</div>\n</div>\n\n<!-- <table>\n  <tr *ngFor=\"let review of results\"> \n      <td>\n      {{review.coin_id}}\n      </td>\n  </tr>\n</table> -->"
